...
export function Analytics() {
  ...
  // overrides per-env, fallback is production. GTM now owns GA4 and
  // Meta Pixel — manage tags + their consent rules in the GTM UI.
  const gtm = process.env.NEXT_PUBLIC_GTM_ID ?? "GTM-KTN8M8RB";

  // Load GTM once any consent is granted. Tag-level consent (GA4 vs
  // Meta Pixel) is enforced inside GTM via Consent Mode / triggers.
